...
<div class="card shadow-xl p-5">
    <form action="{{ route('travels.store') }}" method="POST">
        ...
        <input type="text" class="form-control" name="truck_id"  placeholder="Truck plate" required>
        </div>
        </div>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-md-6">
              <div class="form-group">
        <input type="text" name="trailer_nr"  class="form-control" placeholder="Trailer Plate" required>
        </div>
        </div>
        </div>
